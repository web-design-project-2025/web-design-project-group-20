...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  const articleImg = document.getElementById("detail-article");
  ...
  if (document.getElementById("details")) {
  ...
  } else if (document.getElementById("detail-article")) {
    ...
    const article = articles.find((a) => a.title == whatArticle);

    if (article) {
      articleImg.src = article.icon;
    }
  }
});
